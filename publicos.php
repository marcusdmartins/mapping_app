...
session_start();
ManagerSession::validaAcesso(12);
    ...
    <section id="main">
        ...
        <section id="content" style="margin-top: -15px">
           <div class="container">
                        ...
                        <div class="card-body card-padding">
                            <div class="row">
                                ...
                                <div class="list-group">
                                    ...
                                    <a class="list-group-item media" href="publicoDetail?i=<?php echo $publico->id ?>">
                                        <div class="pull-left">
                                            <img class="lgi-img" src="img/icons/publico.png" alt="">
                                        </div>
                                        <div class="media-body" style="margin-top: 10px">
                                            <div class="lgi-heading"><?php echo $publico->nome ?></div>
                                    ...
                                    <?php
                                            ...
                                            echo "Nenhum publico cadastrado";
                                        }
                                    ?>
                                </div>
                                </div>
                    ...
                    <div class="card-body">
                        <a href="publicoNovo" style="float: right" class="btn bgm-black btn-icon-text"><i class="zmdi zmdi-plus"></i> Novo</a>
                    </div>
            </div>              
