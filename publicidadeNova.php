                ...
                <form class="formulario" action="services/publicidade.php" method="POST">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h2>Nova Publicidade Interna</h2>
                        </div>
                        <div class="card-body card-padding">
                            <div class="row">
                                    ...
                                    <div class="fg-line form-group">
                                        ...
                                        <select class="chosen" name="id_local" id="local" onchange="atualizarCombos()">
                                                ...
                                                foreach ($locais as $local) {
                                                    ?>
                                                    <option value="<?php echo $local->id ?>"><?php echo "$local->nome - $local->nome_subgrupo - $local->nome_grupo" ?></option>
                                                    <?php
                                                }
                                                }else{
                                                    echo 'nenhum local';
                                ...
                                <div class="col-sm-3">
                                    <div class="fg-line form-group">
                                        ...
                                        <input type="text" class="form-control input-sm" data-toggle="datepicker" id="custo" name="custo" required="">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="fg-line form-group">
                                        ...
                                        <input type="number" value="1" class="form-control input-sm" data-toggle="datepicker" id="qtd" name="qtd" required="">
                                    </div>
                                </div>                                
                            ...
                            <div class="row" style="margin-top: 60px">
                                ...
                                <div class="col-sm-6">
                                    <label>Públicos impactados neste local:</label><br><br>
                                    <div class="fg-line form-group" id="impactos"></div>
                                </div>
