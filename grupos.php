    ...
    <section id="main">
        ...
        <section id="content" style="margin-top: -15px">
           <div class="container">
                        ...
                        <div class="card-body card-padding">
                            <div class="row">
                                ...
                                <div class="list-group">
                                    ...
                                    <a class="list-group-item media" href="grupoDetail?i=<?php echo $grupo->id ?>">
                                        <div class="pull-left">
                                            <img style="width: 50px; height: 50px" class="lgi-img" src="img/icons/grupo.png" alt="">
                                        </div>
                                        <div class="media-body">
                                            <div class="lgi-heading" style="margin-top: 15px"><?php echo $grupo->nome ?></div>
                    ...
                    <div class="card-body">
                        <a href="grupoNovo" style="float: right" class="btn bgm-black btn-icon-text"><i class="zmdi zmdi-plus"></i> Novo</a>
                    </div>
            </div>              
