    ...
    <section id="main">
        ...
        <section id="content" style="margin-top: -15px">
           <div class="container">
                    ...
                    <div class="card-body">
                        <a href="publicos" style="float: left" class="btn bgm-gray btn-icon-text"><i class="zmdi zmdi-arrow-back"></i> Voltar</a>
        ...
        <div class="modal fade" id="edit" role="dialog" aria-hidden="true" >
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form class="formularioEdit" action="services/publico.php" method="POST">
