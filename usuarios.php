        ...
        <section id="content" style="margin-top: -15px">
           <div class="container">
               <form class="formularioNivel" action="services/nivel.php" method="POST">
                        ...
                        <div class="card-body card-padding">
                            <div class="row">
                                ...
                                <div class="list-group">
                                    ...
                                    <a class="list-group-item media" href="usuarioDetail?i=<?php echo $usuario->id ?>">
                                        <div class="pull-left">
                                            <img class="lgi-img" src="img/icons/user.png" alt="">
                                        </div>
                                        <div class="media-body">
                                            <div class="lgi-heading"><?php echo $usuario->nome ?></div>
                                            <small class="lgi-text"><?php echo $usuario->email ?></small>
                                            <small class="lgi-text"><?php echo $usuario->tipo_usuario_nome." - ". getStatusUsuario($usuario->bloq) ?></small>
                                        </div>
                                    </a>
                    ...
                    <div class="card-body">
                        <a href="usuarioNovo" style="float: right" class="btn bgm-black btn-icon-text"><i class="zmdi zmdi-plus"></i> Novo</a>
                    </div>
                </form>
