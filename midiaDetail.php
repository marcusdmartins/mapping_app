...
session_start();
ManagerSession::validaAcesso(9);

if(!empty($_GET)){
    $dados = listarMidia($_GET['i']);
    $tiposMidia = listarTipoMidias();
    if($dados == "nenhum"){
    ...
    <section id="main">
        ...
        <section id="content" style="margin-top: -15px">
           <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="fg-line form-group">
                                        ...
                                        <p><?php echo $dados->nome_tipomidia ?></p>
                                    </div>
                                </div>                                
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <a href="midias" style="float: left" class="btn bgm-gray btn-icon-text"><i class="zmdi zmdi-arrow-back"></i> Voltar</a>
        ...
        <div class="modal fade" id="edit" role="dialog" aria-hidden="true" >
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form class="formularioEdit" action="services/midia.php" method="POST">
                            ...
                            <div class="card-body card-padding">
                                ...
                                <div class="col-sm-6">  
                                    <div class="fg-line form-group">
                                        ...
                                        <select class="chosen" name="id_tipomidia">
                                            
                                                <option disabled="" selected="" value="">SELECIONE</option>
                                                <?php
                                                if($tiposMidia != "nenhum"){
                                                foreach ($tiposMidia as $tipomidia) {
                                                    ?>
                                                <option <?php if($tipomidia->id == $dados->id_tipomidia){ ?> selected="" <?php }?> value="<?php echo $tipomidia->id ?>"><?php echo $tipomidia->nome ?></option>
                                                    <?php
                                                }
                                                }else{
                                                    echo 'nenhum tipo de midia';
                                                }
                                                ?>
                                            </optgroup>
