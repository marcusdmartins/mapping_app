...
session_start();
ManagerSession::validaAcesso(13);
    ...
    <section id="main">
        ...
        <section id="content" style="margin-top: -15px">
           <div class="container">
                        ...
                        <div class="card-body card-padding">
                            <div class="row">
                                ...
                                <div class="list-group">
                                    ...
                                    <a class="list-group-item media" href="tipomidiaDetail?i=<?php echo $tipomidia->id ?>">
                                        <div class="pull-left">
                                            <img class="lgi-img" src="img/icons/tipomidia.png" alt="">
                                        </div>
                                        <div class="media-body" style="margin-top: 10px">
                                            <div class="lgi-heading"><?php echo $tipomidia->nome ?></div>
                                    ...
                                    <?php
                                            ...
                                            echo "Nenhum Tipo de Midia cadastrado";
                                        }
                                    ?>
                                </div>
                                </div>
                    ...
                    <div class="card-body">
                        <a href="tipomidiaNova" style="float: right" class="btn bgm-black btn-icon-text"><i class="zmdi zmdi-plus"></i> Novo</a>
                    </div>
            </div>              
