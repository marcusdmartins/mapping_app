        ...
        <section id="content" style="margin-top: -15px">
           <div class="container">
               <form class="formularioNivel" action="services/nivel.php" method="POST">
                        ...
                        <div class="card-body card-padding">
                            <div class="row">
                                ...
                                <div class="list-group">
                                    ...
                                    <a class="list-group-item media" href="tipoUsuarioDetail?i=<?php echo $tipo->id ?>">
                                        <div class="pull-left">
                                            <img class="lgi-img" src="img/icons/tipousuario.png" alt="">
                                        </div>
                                        <div class="media-body">
                                            <div class="lgi-heading"><?php echo $tipo->nome ?></div>
                    ...
                    <div class="card-body">
                        <a href="tipoUsuarioNovo" style="float: right" class="btn bgm-black btn-icon-text"><i class="zmdi zmdi-plus"></i> Novo</a>
                    </div>
                </form>
