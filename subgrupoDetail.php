    ...
    <section id="main">
        ...
        <section id="content" style="margin-top: -15px">
           <div class="container">
                    ...
                    <div class="card-body">
                        <a href="subgrupos" style="float: left" class="btn bgm-gray btn-icon-text"><i class="zmdi zmdi-arrow-back"></i> Voltar</a>
        ...
        <div class="modal fade" id="edit" role="dialog" aria-hidden="true" >
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form class="formularioEdit" action="services/subgrupo.php" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">  
                                        <div class="fg-line form-group">
                                            ...
                                            <select class="chosen" placeholder="Selecione o grupo" name="id_grupo">
                                                    ...
                                                    foreach ($grupos as $grupo) {
                                                        ?>
                                                    <option <?php if($dados->id_grupo == $grupo->id){?> selected="" <?php } ?> value="<?php echo $grupo->id ?>"><?php echo $grupo->nome ?></option>
                                                        <?php
                                                    }
                                                    }else{
                                                        echo 'nenhum grupo';
