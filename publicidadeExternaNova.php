                ...
                <form class="formulario" action="services/publicidade.php" method="POST">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h2>Nova Publicidade Externa</h2>
                        </div>
                            ...
                            <div class="row" style="margin-top: 10px">
                                ...
                                <div class="col-sm-3">
                                    <div class="fg-line form-group">
                                        ...
                                        <input type="text" class="form-control input-sm" id="lat" name="latitude" required="">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="fg-line form-group">
                                        ...
                                        <input type="text" class="form-control input-sm" id="lng" name="longitude" required="">
                                    </div>
                                </div>                                
                            </div>                            
...
//            createMarker("-2.518633", "-44.273589");
//        }
...
<script>
    ...
    function initialize() {
       var mapOptions = {
          center: new google.maps.LatLng(-2.522966, -44.245136),
          zoom: 14,
          mapTypeId: 'roadmap'
       };
