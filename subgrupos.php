...
<body>
    ...
    <section id="main">
        ...
        <section id="content" style="margin-top: -15px">
           <div class="container">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div style="margin-top: 25px" class="fg-line form-group" style="float: left; width: 20%">
                                ...
                                <select class="chosen" placeholder="Selecione o grupo" id="grupo" onchange="subgrupoPorGrupo()">
                        ...
                        <div class="card-body card-padding">
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <a class="list-group-item media" href="subgrupoDetail?i=<?php echo $subgrupo->id ?>">
                                        <div class="pull-left">
                                            <img class="lgi-img" src="img/icons/subgrupo.png" alt="">
                                        </div>
                                        <div class="media-body">
                                            <div class="lgi-heading"><?php echo $subgrupo->nome ?></div>
                                            <small class="lgi-text"><?php echo $subgrupo->nome_grupo ?></small> 
                                        </div>
                                    </a>
                                    ...
                                    <?php
                                            ...
                                            echo "Nenhum subgrupo cadastrado";
                                        }
                                    ?>
                                </div>
                                </div>
                    ...
                    <div class="card-body">
                        <a href="subgrupoNovo" style="float: right" class="btn bgm-black btn-icon-text"><i class="zmdi zmdi-plus"></i> Novo</a>
                    </div>
            </div>              
    ...
    <script>
        ...
        function subgrupoPorGrupo(){
                $.ajax({
                    url: "services/subgrupo.php",
                    type: 'POST',
                    data: {function: 'subgrupoPorGrupo', id_grupo: $("#grupo").val()},
