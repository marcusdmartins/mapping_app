...
<body>
    ...
    <section id="main">
        ...
        <section id="content" style="margin-top: -15px">
           <div class="container">
               <form class="formulario" action="services/pessoa.php" method="POST">
                    ...
                    <div class="card-body">
                        <a href="grupos" style="float: left" class="btn bgm-gray btn-icon-text"><i class="zmdi zmdi-arrow-back"></i> Voltar</a>
