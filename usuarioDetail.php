    ...
    <section id="main">
        ...
        <section id="content" style="margin-top: -15px">
           <div class="container">
                        ...
                        <div class="card-body card-padding">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="fg-line form-group">
                                        <label>Status</label>
                                        <p><?php echo getStatusUsuario($dados->bloq) ?></p>
                                    </div>
                                </div>                                
                    ...
                    <div class="card-body">
                        <a href="usuarios" style="float: left" class="btn bgm-gray btn-icon-text"><i class="zmdi zmdi-arrow-back"></i> Voltar</a>
                        
                        <?php
                            if($dados->bloq == 'n'){
                        ?>
                            <a style="float: right; margin: 5px" class="btn bgm-red btn-icon-text bloq" id="bloq"><i class="zmdi zmdi-block"></i> Bloquear</a>
                        <?php
                        }else{
                        ?>
                            <a style="float: right; margin: 5px" class="btn bgm-bluegray btn-icon-text desbloq" id="desbloq"><i class="zmdi zmdi-lock-open"></i> Desbloquear</a>
                        <?php
                        }
                        ?>
                        ...
                        <a style="float: right; margin: 5px" class="btn bgm-black btn-icon-text reset"><i class="zmdi zmdi-dialpad"></i> Resetar senha</a>
                    </div>
            </div>              
        </section>
                            ...
                            <div class="card-body card-padding">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="fg-line form-group">
                                            <label>Tipo de usuário</label>
                                            <select class="chosen" name="tipoUsuario">
                                                <?php
                                                foreach ($tiposUsuario as $tipo){
                                                ?>

                                                <option <?php if($tipo->id == $dados->tipo_usuario){ ?> selected="" <?php }?> value="<?php echo $tipo->id ?>"><?php echo $tipo->nome ?></option>
